...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            for(int i = 0; i < JFacturacion.jTable_productos.getRowCount(); i++){
                String producto = JFacturacion.jTable_productos.getValueAt(i, 1).toString();
                String cantidad = JFacturacion.jTable_productos.getValueAt(i, 2).toString();
                String precio = JFacturacion.jTable_productos.getValueAt(i, 3).toString();
                String total = JFacturacion.jTable_productos.getValueAt(i, 7).toString();
            ...
            info.add("Total a pagar: " + JFacturacion.txt_total_pagar.getText());
