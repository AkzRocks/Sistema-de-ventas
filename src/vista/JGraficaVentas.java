 ...
 * @author will
 */
public class JGraficaVentas extends javax.swing.JInternalFrame {
    ...
    private int MetodoContador() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    ...
                    + "where fechaVenta BETWEEN '" + JGraficas.fecha_inicio + "' and '" + JGraficas.fecha_fin + "' group by fechaVenta;");
